...
<body>
  ...
  <table width='80%' border=1>
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='editdatabarangelektronik.php?images=$user_data[images]'>Edit</a> | <a href='deletedatabarangelektronik.php?images=$user_data[images]'>Delete</a></td></tr>";        
    }
    ?>
  </table>
